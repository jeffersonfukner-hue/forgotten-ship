...
- Bloco de Entidades de Chefes: estrutura de ondas detalhada — Onda 1 (1 swarm central + 1 mini-chefe), Onda 2 (2 swarms divididos + 1 mini-chefe central + 1 chefe), Onda 3/final (3 swarms + 2 mini-chefes + 1 chefe + o chefão); cada onda com tempo próprio; contador grande de countdown até o chefão; "swarm" = leva inteira chegando de uma vez (mecânica de pico de dificuldade, distinta do reabastecimento gradual padrão)
